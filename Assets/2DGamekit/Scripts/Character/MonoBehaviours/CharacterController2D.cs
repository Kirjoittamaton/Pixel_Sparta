...
namespace Gamekit2D
{
    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        [SerializeField]
        private float groundedRaycastDistanceSerialized = 0.1f; // Adjust this value in the Inspector

        [SerializeField]
        private float ceilingRaycastDistanceSerialized = 0.1f; // Adjust this value in the Inspector
        ...
        public void CheckCapsuleEndCollisions(bool bottom = true)
        {
            ...
            {
                // Adjust the starting point based on capsule offset
                raycastStart = m_Rigidbody2D.position + m_Capsule.offset;

                // Correct for the Y offset of -0.1
                raycastStart.y -= 0.1f; // Adjust this value as needed
